...
export default function StudentDashboard() {
  ...
  useEffect(() => {
    ...
    // Mock fetching student's enrolled classes
    setClasses([
       { 
         _id: 'c1', 
        ...
        {classes.length === 0 ? (
          ...
          classes.map((cls) => (
            <div key={cls._id} className="glass-card" style={{ display: 'flex', flexDirection: 'column' }}>
               ...
               <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', marginBottom: '1.5rem' }}>Instructor: {cls.instructor}</p>
               ...
               <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1.5rem' }}>
                  <div style={{ background: 'var(--bg-tertiary)', padding: '1rem', borderRadius: 'var(--radius-md)', textAlign: 'center' }}>
                     ...
                     <span style={{ display: 'block', fontSize: '1.25rem', fontWeight: 'bold' }}>{cls.pendingQuizzes}</span>
                  ...
                  <div style={{ background: 'var(--bg-tertiary)', padding: '1rem', borderRadius: 'var(--radius-md)', textAlign: 'center' }}>
                     ...
                     <span style={{ display: 'block', fontSize: '1.25rem', fontWeight: 'bold' }}>{cls.completedQuizzes}</span>
